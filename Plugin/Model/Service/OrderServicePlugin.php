...
namespace Dotsquare\Giftcard\Plugin\Model\Service;
 ...
 *
 * @package Dotsquare\Giftcard\Plugin\Model\Service
 */
class OrderServicePlugin
{
    /**
    ...
    public function aroundCancel($subject, \Closure $proceed, $orderId)
    {
        ...
        if ($result) {
            ...
            if ($order->getExtensionAttributes() && $order->getExtensionAttributes()->getDsGiftcardCodes()) {
                $giftcards = $order->getExtensionAttributes()->getDsGiftcardCodes();
