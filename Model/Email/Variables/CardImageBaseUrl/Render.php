...
namespace Dotsquare\Giftcard\Model\Email\Variables\CardImageBaseUrl;
 ...
 * Class Render
 *
 * @package Dotsquare\Giftcard\Model\Email\Variables\CardImageBaseUrl
 */
class Render
{
    /**
    ...
    public function render($storeId, $productId, $templateId)
    {
        ...
        return $templateImage
            ...
            : $this->assetRepo->getUrl('Dotsquare_Giftcard::images/email/cards') . '/';
    }
