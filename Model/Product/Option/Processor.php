...
namespace Dotsquare\Giftcard\Model\Product\Option;
 ...
 * Class Processor
 *
 * @package Dotsquare\Giftcard\Model\Product\Option
 */
class Processor implements ProductOptionProcessorInterface
{
    ...
    public function convertToProductOption(DataObject $request)
    {
        ...
        if (!empty($options) && is_array($options)) {
            ...
            return ['ds_giftcard_option' => $giftcardOptionObject];
        };
    ...
    private function getGiftcardOptions(ProductOptionInterface $productOption)
    {
        if ($productOption
            ...
            return $productOption->getExtensionAttributes()->getDsGiftcardOption()->getData();
        }
        return [];
    }
}
