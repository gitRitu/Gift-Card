...
class CartItemProcessor implements CartItemProcessorInterface
{
    ...
    public function convertToBuyRequest(CartItemInterface $cartItem)
    {
        ...
        if ($productOptions && $productOptions->getExtensionAttributes()
            && $productOptions->getExtensionAttributes()->getDsGiftcardOption()
        ) {
            $options = $productOptions->getExtensionAttributes()->getDsGiftcardOption()->getData();
            if (!is_array($options)) {
                return null;
            }
            $requestData = [];
    ...
    public function processOptions(CartItemInterface $cartItem)
    {
        ...
        $extensibleAttribute->setDsGiftcardOption($giftcardOptionObject);
