...
namespace Dotsquare\Giftcard\Model\ResourceModel\Product;
 ...
 * Class Collection
 *
 * @package Dotsquare\Giftcard\Model\ResourceModel\Product
 */
class Collection extends ProductCollection
{
    ...
    {
        if (in_array($field, $this->statisticsFields) || $field == 'ds_gc_email_template') {
    ...
    protected function _renderFiltersBefore()
    {
        ...
        if ($this->getFilter('ds_gc_email_template')) {
            $this->joinLinkageTable(
                'ds_giftcard_product_entity_templates',
                'entity_id',
                'entity_id',
                'ds_gc_email_template',
                'value'
            );
        }
    ...
    private function getStatisticsQuery()
    {
        $select = $this->getConnection()->select()
            ->from(
                ['dsgc_stat_table' => $this->getTable('ds_giftcard_statistics')],
                $this->getAggregateStatisticsColumns()
            )->group(['product_id']);
        if ($this->storeIds) {
