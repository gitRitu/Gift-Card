...
namespace Dotsquare\Giftcard\Model\ResourceModel\Product\Relation\Templates;
 ...
 * Class SaveHandler
 *
 * @package Dotsquare\Giftcard\Model\ResourceModel\Product\Relation\Templates
 */
class SaveHandler implements ExtensionInterface
{
    ...
    public function execute($entity, $arguments = [])
    {
        ...
        $templates = $entity->getExtensionAttributes()->getDsGiftcardTemplates();
        if (!empty($templates)) {
