...
namespace Dotsquare\Giftcard\Model\ResourceModel\Product\Relation\Amounts;
 ...
 * Class SaveHandler
 *
 * @package Dotsquare\Giftcard\Model\ResourceModel\Product\Relation\Amounts
 */
class SaveHandler implements ExtensionInterface
{
    ...
    public function execute($entity, $arguments = [])
    {
        ...
        $amounts = !empty($entity->getExtensionAttributes()->getDsGiftcardAmounts())
            ? $entity->getExtensionAttributes()->getDsGiftcardAmounts()
            : [];
