...
namespace Dotsquare\Giftcard\Model\ResourceModel\Pool\Grid;
 ...
 * Class Collection
 *
 * @package Dotsquare\Giftcard\Model\ResourceModel\Pool\Grid
 */
class Collection extends PoolCollection implements SearchResultInterface
{
    ...
    private function getNumberCodesQuery()
    {
        $select = $this->getConnection()->select()
            ->from(
                ['tmp_table' => $this->getTable('ds_giftcard_pool_code')],
