<?php
namespace Dotsquare\Giftcard\Model\ResourceModel\Giftcard\History;

use Dotsquare\Giftcard\Model\Giftcard\History;
use Dotsquare\Giftcard\Model\ResourceModel\Giftcard\History as ResourceHistory;
 ...
 * Class Collection
 *
 * @package Dotsquare\Giftcard\Model\ResourceModel\History
 */
class Collection extends AbstractCollection
{
    ...
    protected function _initSelect()
    {
        ...
        $this->getSelect()->joinLeft(
            ['dsgc_table' => $this->getTable('ds_giftcard')],
            'main_table.giftcard_id = dsgc_table.id',
            ['website_id']
        );
        return $this;
    }
