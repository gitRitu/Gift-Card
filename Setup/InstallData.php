...
use Dotsquare\Giftcard\Model\Source\Entity\Attribute\GiftcardPool;
...
use Dotsquare\Giftcard\Model\Email\Sample as SampleEmailTemplate;
...
class InstallData implements InstallDataInterface
{
    ...
    public function install(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        $attributes = [
            'ds_giftcard_amount' => ['type' => Table::TYPE_DECIMAL],
            'base_ds_giftcard_amount' => ['type' => Table::TYPE_DECIMAL]
        ];
        ...
        $salesSetup->addAttribute('order', 'base_ds_giftcard_invoiced', ['type' => Table::TYPE_DECIMAL]);
        $salesSetup->addAttribute('order', 'ds_giftcard_invoiced', ['type' => Table::TYPE_DECIMAL]);
        $salesSetup->addAttribute('order', 'base_ds_giftcard_refunded', ['type' => Table::TYPE_DECIMAL]);
        $salesSetup->addAttribute('order', 'ds_giftcard_refunded', ['type' => Table::TYPE_DECIMAL]);
        ...
        $this->eavSetup
            ->addAttribute(
                $this->entityTypeId,
                ProductAttributeInterface::CODE_DS_GC_TYPE,
                [
                    'type' => 'int',
                    'label' => 'Card Type',
                    'input' => 'select',
                    'required' => true,
                    'frontend' => '',
                    'source' => \Dotsquare\Giftcard\Model\Source\Entity\Attribute\GiftcardType::class,
                ...
                $this->entityTypeId,
                ProductAttributeInterface::CODE_DS_GC_DESCRIPTION,
                [
                    'type' => 'text',
                ...
                $this->entityTypeId,
                ProductAttributeInterface::CODE_DS_GC_CUSTOM_MESSAGE_FIELDS,
                [
                    'type' => 'int',
                ...
                [
                    ...
                    'input' => 'select',
                    'backend' => \Dotsquare\Giftcard\Model\Product\Entity\Attribute\Backend\Templates::class,
                    'frontend' => '',
                    'global' => CatalogEavAttribute::SCOPE_STORE,
                    'user_defined' => false,
                    'searchable' => false,
                ...
                [
                    ...
                    'label' => 'Amounts',
                    'input' => 'select',
                    'backend' => \Dotsquare\Giftcard\Model\Product\Entity\Attribute\Backend\Amounts::class,
                    'frontend' => '',
                    'required' => false,
                    'global' => CatalogEavAttribute::SCOPE_GLOBAL,
                    'user_defined' => false,
                ...
                $this->entityTypeId,
                ProductAttributeInterface::CODE_DS_GC_ALLOW_OPEN_AMOUNT,
                [
                    'type' => 'int',
                ...
                $this->entityTypeId,
                ProductAttributeInterface::CODE_DS_GC_OPEN_AMOUNT_MIN,
                [
                    'type' => 'decimal',
                ...
                $this->entityTypeId,
                ProductAttributeInterface::CODE_DS_GC_OPEN_AMOUNT_MAX,
                [
                    'type' => 'decimal',
                ...
                $this->entityTypeId,
                ProductAttributeInterface::CODE_DS_GC_ALLOW_DELIVERY_DATE,
                [
                    'type' => 'int',
                ...
                $this->entityTypeId,
                ProductAttributeInterface::CODE_DS_GC_DAYS_ORDER_DELIVERY,
                [
                    'type' => 'int',
                ...
                $this->entityTypeId,
                ProductAttributeInterface::CODE_DS_GC_POOL,
                [
                    'type' => 'int',
                    'label' => 'Pool',
                    'input' => 'select',
