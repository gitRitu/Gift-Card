...
use Dotsquare\Giftcard\Model\Source\Entity\Attribute\GiftcardEmailTemplate;
...
class Templates extends AbstractModifier
{
    ...
    {
        $fieldName = static::CONTAINER_PREFIX . ProductAttributeInterface::CODE_DS_GC_EMAIL_TEMPLATES;
        ...
        $meta = $this->arrayManager->set(
            $containerPath . '/children/' . ProductAttributeInterface::CODE_DS_GC_EMAIL_TEMPLATES,
            $meta,
            [
                'arguments' => [
                    'data' => [
                        'config' => [
                            ...
                            'component' => 'Dotsquare_Giftcard/js/ui/dynamic-rows/dynamic-rows',
                                ...
                                'arguments' => [
                                    'data' => [
                                        'config' => [
                                            ...
                                            'component' => 'Dotsquare_Giftcard/js/ui/form/element/product/email-templates/image-uploader',
                                            'template' => 'Dotsquare_Giftcard/ui/form/element/product/email-templates/image-uploader',
                                            'previewTmpl' => 'Dotsquare_Giftcard/ui/form/element/product/email-templates/image-preview',
                                            'imagePlaceholderText' => __('Click here or drag and drop to add images.'),
                                            'allowedExtensions' => 'jpg jpeg gif png',
                                            'uploaderConfig' => [
                                                'url' => 'ds_giftcard_admin/product/imageUpload'
                                            ],
                    ...
                    'switcherConfig' => [
                        ...
                        'rules' => [
                            [
                                ...
                                'actions' => [
                                    [
                                        'target' => 'product_form.product_form.gift-card-information.container_ds_gc_email_templates.ds_gc_email_templates',
                                        'callback' => 'show'
                                    ],
                                    [
                                        'target' => 'product_form.product_form.gift-card-information.container_ds_gc_days_order_delivery.ds_gc_days_order_delivery',
                                        'callback' => 'hide'
                                    ]
                                ]
                            ],
    ...
    public function modifyData(array $data)
    {
        ...
        if (isset($data[$modelId][self::DATA_SOURCE_DEFAULT]['ds_gc_email_templates'])
            && is_array($data[$modelId][self::DATA_SOURCE_DEFAULT]['ds_gc_email_templates'])
        ) {
            foreach ($data[$modelId][self::DATA_SOURCE_DEFAULT]['ds_gc_email_templates'] as $index => $template) {
                if (isset($template['image'])) {
                    $data[$modelId][self::DATA_SOURCE_DEFAULT]['ds_gc_email_templates'][$index]['image'] = [
                        'file' => $template['image'],
                        'name' => '',
