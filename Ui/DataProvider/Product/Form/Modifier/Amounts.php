...
class Amounts extends AbstractModifier
{
    ...
    {
        $fieldName = static::CONTAINER_PREFIX . ProductAttributeInterface::CODE_DS_GC_AMOUNTS;
        if (!$this->getGroupCodeByField($meta, $fieldName)) {
            return $this;
        }
        $containerPath = $this->arrayManager->findPath($fieldName, $meta);
        $meta = $this->arrayManager->set(
            $containerPath . '/children/' . ProductAttributeInterface::CODE_DS_GC_AMOUNTS,
            $meta,
            [
                'arguments' => [
                    'data' => [
                            ...
                            'actions' => [
                                [
                                    'target' => 'product_form.product_form.gift-card-information.'
                                        . 'container_ds_gc_open_amount_min.ds_gc_open_amount_min',
                                    'callback' => 'hide'
                                ],
                                [
                                    'target' => 'product_form.product_form.gift-card-information.'
                                        . 'container_ds_gc_open_amount_max.ds_gc_open_amount_max',
                                    'callback' => 'hide'
                                ]
                            ]
                        ],
