...
define([
    ...
    $.widget('mage.dsGiftCardManagement', {
        options: {
            checkCodeSelector: '[data-role=ds-giftcard-check-code-action]',
            applyCodeSelector: '[data-role=ds-giftcard-apply-action]',
            resultSelector: '#ds_giftcard__code_info'
        },
    ...
    return $.mage.dsGiftCardManagement;
});
