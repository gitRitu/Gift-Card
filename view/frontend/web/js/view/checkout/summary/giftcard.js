define([
    ...
    'Dotsquare_Giftcard/js/action/remove-giftcard-code',
], function ($, Component, totals, removeAction) {
    'use strict';

    var giftcardRemoveUrl = window.checkoutConfig.dsGiftcard.removeUrl;

    return Component.extend({
        defaults: {
            template: 'Dotsquare_Giftcard/checkout/summary/giftcard'
        },
        ...
        getGiftcardCodes: function () {
            if (this.totals && totals.getSegment(this.code)) {
                var giftcardCodes = totals.getSegment(this.code).extension_attributes.ds_giftcard_codes;
