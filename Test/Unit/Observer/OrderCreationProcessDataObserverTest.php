...
use Dotsquare\Giftcard\Observer\OrderCreationProcessDataObserver;
 ...
 * Test for \Dotsquare\Giftcard\Observer\OrderCreationProcessDataObserver
 *
...
class OrderCreationProcessDataObserverTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testApplyGiftcardCode()
    {
        ...
        $giftcardCode = 'gccode';
        $request = [
            'ds_giftcard_apply' => $giftcardCode
        ];
    ...
    public function testRemoveGiftcardCode()
    {
        ...
        $giftcardCode = 'gccode';
        $request = [
            'ds_giftcard_remove' => $giftcardCode
        ];
