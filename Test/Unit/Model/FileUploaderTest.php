...
use Dotsquare\Giftcard\Model\FileUploader as GiftcardFileUploader;
 ...
 * Test for \Dotsquare\Giftcard\Model\FileUploader
 *
...
class FileUploaderTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $baseMediaUrl = 'https://ecommerce.Dotsquare.com/pub/media/';
        $tmpMediaPath = '/tmp/media';
        $fileName = 'file.csv';
        $fileSize = '123';
        $fileCode = 'img';
        $filePath = '/var/www/mysite/pub/media/ds_giftcard/imports';
