...
namespace Dotsquare\Giftcard\Test\Unit\Block\Customer\Giftcard;

use Dotsquare\Giftcard\Api\GiftcardManagementInterface;
use Dotsquare\Giftcard\Block\Customer\Giftcard\Codes;
...
/**
 * Class CodesTest
 * Test for \Dotsquare\Giftcard\Block\Customer\Giftcard\Codes
 *
 * @package Dotsquare\Giftcard\Test\Unit\Block\Customer\Giftcard
 */
class CodesTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        return [
            ['dsgiftcard', 'card', true],
            ['dsgiftcard', 'product', false]
        ];
    }
